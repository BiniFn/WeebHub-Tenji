# WeebHub Tenji Contribution Guide

Contributions to WeebHub Tenji are welcome. This guide outlines how to set up the repository for local development, run the application, and submit code changes.
...
To build and run WeebHub Tenji, ensure your machine has the following tools installed:
...
WeebHub Tenji is built using Expo and React Native.
