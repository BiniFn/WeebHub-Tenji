...
WeebHub Tenji is an open-source mobile application. To respect open-source compliance and support the ecosystem, the codebase uses a dual/file-level licensing structure.

## Main Application License

The overall WeebHub Tenji application, including its user interface, custom state management, components, API client layer, and application-specific logic, is licensed under the **GNU General Public
...
integrations made high-quality background downloading and native MPV integrations accessible and served as the perfect blueprint for WeebHub Tenji's native extensions.
