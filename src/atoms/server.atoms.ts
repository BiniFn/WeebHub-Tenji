...
const serverUrlAtom = atomWithStorage<string | null>("weeb-server-url", null, createAtomStorage<string | null>(), { getOnInit: true })
export const SERVER_AUTH_TOKEN_STORAGE_KEY = "weeb-server-auth-token"
...
export const serverStatusAtom = atomWithStorage<Status | null>("weeb-server-status", null, createAtomStorage<Status | null>(), { getOnInit: true })
