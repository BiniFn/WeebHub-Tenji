...
const OFFLINE_LOGS_STORAGE_KEY = "weeb-offline-log-entries"
const OFFLINE_LOGGING_ENABLED_STORAGE_KEY = "weeb-offline-logging-enabled"
...
function redactSensitiveText(value: string): string {
    return value
        ...
        .replace(/\/Users\/.+?\/weebhub-tenji\//g, "[weeb]/")
        .replace(/\/home\/.+?\/weebhub-tenji\//g, "[weeb]/")
