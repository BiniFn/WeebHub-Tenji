...
const CLIENT_ID_STORAGE_KEY = "weeb-server-client-id"
const CLIENT_ID_PROOF_STORAGE_KEY = "weeb-server-client-id-proof"

const CLIENT_ID_HEADER_NAME = "X-WeebHub-Client-Id"
const CLIENT_ID_PROOF_HEADER_NAME = "X-WeebHub-Client-Id-Proof"
const CLIENT_PLATFORM_HEADER_NAME = "X-WeebHub-Client-Platform"
...
function createClientId(): string {
    ...
    return `weebhub-${Math.random().toString(16).slice(2)}-${Date.now().toString(16)}`
}
